<?php
/**
 * Overwrite export_wp function to add filter in post_ids
 */
 ...
 * }
 */
function jflalarmescore_export_wp( $args = array() ) {
	global $wpdb, $post;
	...
	$post_ids = apply_filters( 'export_wp_post_ids', $post_ids, $args );
